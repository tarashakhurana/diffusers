...
from .unet_2d_blocks import UNetMidBlock2D, get_down_block, get_up_block, get_rendering_transformer_block


@dataclass
class UNet2DOutput(BaseOutput):
    """
    The output of [`UNet2DRenderModel`].
...
class UNet2DRenderModel(ModelMixin, ConfigMixin):
    r"""
    ...
    def forward(
        ...
        r"""
        The [`UNet2DRenderModel`] forward method.
