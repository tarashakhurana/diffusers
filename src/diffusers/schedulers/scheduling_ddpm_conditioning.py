...
class DDPMConditioningScheduler(SchedulerMixin, ConfigMixin):
    """
    ...
    def step(
        ...
        # 3.5. Replace the conditioning indices by the actual conditioning image
        pred_original_sample[:, cond_inds, ...] = conditioning
