...
def main(args):
    ...
    for b, batch in enumerate(train_dataloader):
        ...
        # but now we need to find top 1, top 3, and top 5 numbers
        ...
        top5_groundtruth = future_frames[:5, ...]
        top5_metric += topk_l1_error(top5_prediction, top5_groundtruth)
        top5_inv_metric += topk_scaleshift_inv_l1_error(top5_prediction, top5_groundtruth)
